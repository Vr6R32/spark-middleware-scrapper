...
public interface CryptoDataServiceClient {
    ...
    List<CurrencyPairSingleRateHistoryResponse> getAvailableCurrencyPairsLatestCurrencyRate(@RequestParam(defaultValue = "Europe/Warsaw", required = false, name = "userZoneId") String userZoneId);
